...
void fp_gpu(lbann_comm& comm,
  ...
  // The comm templates will not do this implicit conversion, so I'm
  // going to explicitly do it here. For clarity, I will use
  // "sync_info" globally, even when "multisync" would work.
  ...
  // FIXME (trb 04/27/2020): We should sync work on this, too.
