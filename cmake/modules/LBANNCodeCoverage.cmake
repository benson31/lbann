...
if (LLVM_COV_PROGRAM AND LLVM_PROFDATA_PROGRAM)
  set(LBANN_HAVE_LLVM_COVERAGE_TOOLS TRUE)
...
if (NOT LBANN_HAVE_LLVM_COVERAGE_TOOLS)
  if (CMAKE_CXX_COMPILER_ID MATCHES "(Apple)?[Cc]lang")
  ...
  if (GCOV_PROGRAM AND LCOV_PROGRAM AND GENHTML_PROGRAM)
    set(LBANN_HAVE_GCOV_COVERAGE_TOOLS ON)
...
if (NOT (LBANN_HAVE_LLVM_COVERAGE_TOOLS OR LBANN_HAVE_GCOV_COVERAGE_TOOLS))
  message(FATAL_ERROR
...
if (LBANN_HAVE_LLVM_COVERAGE_TOOLS AND
    (CMAKE_CXX_COMPILER_ID MATCHES "(Apple)?[Cc]lang"))

  set(LBANN_HAS_CODE_COVERAGE TRUE)
  ...
  macro(add_code_coverage EXE_TARGET MASTER_TARGET)
    ...
    target_link_libraries(${EXE_TARGET} PRIVATE lbann_coverage_flags)
  endmacro()
...
elseif (LBANN_HAVE_GCOV_COVERAGE_TOOLS)
...
add_library(lbann_coverage_flags INTERFACE)
target_compile_options(lbann_coverage_flags INTERFACE
  $<$<COMPILE_LANGUAGE:CXX>:${COVERAGE_FLAGS}>)
target_link_options(lbann_coverage_flags INTERFACE ${COVERAGE_FLAGS})
